...
void FPivotToolModule::RegisterMenu()
{
	...
	const FText MSToolGroupName = LOCTEXT("MSTools", "Mod's Tools");
	TSharedRef<FWorkspaceItem> ModsToolsMenuGroup = MenuGroupHelper::FindOrCreateGroup(ModsToolGroupName);
