...
void FPivotToolStyle::SetupStyles(FSlateStyleSet* Style)
{
	...
	// Button Style
	{
		...
		FButtonStyle HyperlinkButton = FButtonStyle(FEditorStyle::Get().GetWidgetStyle<FButtonStyle>("Documentation.Hyperlink.Button"));//  // Credits.Hyperlink
	...
	// Checkbox Style
	{
		...
		const FCheckBoxStyle& DefaultToggleButtonStyle = FEditorStyle::Get().GetWidgetStyle<FCheckBoxStyle>("ToggleButtonCheckbox");
