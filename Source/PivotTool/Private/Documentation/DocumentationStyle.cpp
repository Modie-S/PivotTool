...
#define IMAGE_BRUSH(RelativePath, ...) FSlateImageBrush(((FSlateStyleSet*)(&FEditorStyle::Get()))->RootToContentDir(RelativePath, TEXT(".png")), __VA_ARGS__)
#define BOX_BRUSH(RelativePath, ...) FSlateBoxBrush(((FSlateStyleSet*)(&FEditorStyle::Get()))->RootToContentDir(RelativePath, TEXT(".png")), __VA_ARGS__)
#define BORDER_BRUSH(RelativePath, ...) FSlateBorderBrush(((FSlateStyleSet*)(&FEditorStyle::Get()))->RootToContentDir(RelativePath, TEXT(".png")), __VA_ARGS__)
