	...
	MainContent->SetContent(
		...
		[
				...
				[
					...
					[
						...
						[
							...
							.Visibility(MakeAttributeLambda([=] {return WidthLastFrame >= 180.f ? EVisibility::Visible : EVisibility::Collapsed; }))
						...
						[
							...
							.IsEnabled(MakeAttributeLambda([=] { return !bBakeByActor; }))
			...
			[
				...
				[
					...
					[
						...
						.IsChecked(MakeAttributeLambda([=] {return bCopyPivotInWorldSpace ? ECheckBoxState::Checked : ECheckBoxState::Unchecked; }))
					...
					[
						...
						.IsChecked(MakeAttributeLambda([=] {return bDisplayAlignActors ? ECheckBoxState::Checked : ECheckBoxState::Unchecked; }))
			...
			[
				...
				.BorderImage(FEditorStyle::GetBrush("ToolPanel.GroupBorder"))
				.HAlign(HAlign_Center)
				.Visibility(MakeAttributeLambda([=] {return bDisplayAlignActors ? EVisibility::Visible : EVisibility::Collapsed; }))
				[
			...
			+ SHorizontalBox::Slot()
				...
				[
					...
					.IsChecked(MakeAttributeLambda([=] {return bFreezeRotation ? ECheckBoxState::Checked : ECheckBoxState::Unchecked; }))
					.IsEnabled(MakeAttributeLambda([=] { return !bBakeByActor; }))
			...
			+ SHorizontalBox::Slot()
				...
				[
					...
					.IsChecked(MakeAttributeLambda([=] {return bFreezeScale ? ECheckBoxState::Checked : ECheckBoxState::Unchecked; }))
					.IsEnabled(MakeAttributeLambda([=] { return !bBakeByActor; }))
					.ToolTip(FPivotToolCommands::Get().CreateToolTip(FPivotToolCommands::Get().ToggleBakeFreezeRotation))
					.Content()
					[
				...
				[
					...
					.IsChecked(MakeAttributeLambda([=] {return bKeepActorsInPlace ? ECheckBoxState::Checked : ECheckBoxState::Unchecked; }))
					.IsEnabled(MakeAttributeLambda([=] {return !bBakeByActor; }))
				...
				[
					...
					.IsChecked(MakeAttributeLambda([=] {return bDisplayMatchActors ? ECheckBoxState::Checked : ECheckBoxState::Unchecked; }))
			...
			[
				...
				.BorderImage(FEditorStyle::GetBrush("ToolPanel.GroupBorder"))
				.HAlign(HAlign_Center)
				.Visibility(MakeAttributeLambda([=] {return bDisplayMatchActors ? EVisibility::Visible : EVisibility::Collapsed; }))
				[
					SNew(SHorizontalBox)
#if 0
					+ SHorizontalBox::Slot()
					...
					[
						...
						.IsChecked(MakeAttributeLambda([=] {return bBakeByActor ? ECheckBoxState::Checked : ECheckBoxState::Unchecked; }))
						.ToolTip(FPivotToolCommands::Get().CreateToolTip(FPivotToolCommands::Get().ToggleBakeByActor))
 						.Content()
 						[
							SNew(STextBlock)
...
TSharedRef<SWidget> SPivotToolWidget::CreateChangeLogWidget()
{
	...
	return SNew(SBorder)
		...
		.BorderImage(FEditorStyle::GetBrush("ToolPanel.GroupBorder"))
		.Padding(6.f)
		.Visibility(MakeAttributeLambda([=] {return bShowChangelog ? EVisibility::Visible : EVisibility::Collapsed; }))
		[
			SNew(SVerticalBox)
